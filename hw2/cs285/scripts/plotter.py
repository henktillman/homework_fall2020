...
pwd = "/Users/henktillman/Dropbox/Berkeley/8/cs285/hw/hw2/data/"
fields = ['Eval_AverageReturn', 'Eval_StdReturn']


# Experiment 1

folder = "/exp1_data_final2/"
...
#     ] for log in graph1_logs
# ]
# plot_lines(np.arange(len(graph1_data[0][0])), graph1_data, [log[0] for log in graph1_logs], title="Experiment 2 Inverted Pendulum")
...
#     ] for log in graph1_logs
# ]
# plot_lines(np.arange(len(graph1_data[0][0])), graph1_data, [log[0] for log in graph1_logs], title="Experiment 3 Lunar Lander")
...
#     ] for log in graph1_logs
# ]
# plot_lines(np.arange(len(graph1_data[0][0])), graph1_data, [log[0] for log in graph1_logs], title="Experiment 4a Search")
